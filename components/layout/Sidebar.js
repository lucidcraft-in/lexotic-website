				...
				<div className="sidebar-menu-dashboard">
					<ul className="box-menu-dashboard">
						...
						<li className={`nav-menu-item ${pathname === '/my-property' ? 'active' : ''}`}>
							<Link className="nav-menu-link" href="/my-orderuser"><span className="icon icon-list-dashes" />My Order</Link>
						</li>
						...
						<li className={`nav-menu-item ${pathname === '/my-profileuser' ? 'active' : ''}`}>
							<Link className="nav-menu-link" href="/my-profileuser"><span className="icon icon-profile" /> My Profile</Link>
						</li>
						...
						<li className={`nav-menu-item ${pathname === '/' ? 'active' : ''}`}>
							<Link className="nav-menu-link" href="/" ><span className="icon icon-sign-out" /> <button className='btn btn-info'  onClick={handleLogout}>Logout</button></Link>
						</li>
					</ul>
				</div>
			) : (
