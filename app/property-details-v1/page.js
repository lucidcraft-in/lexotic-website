...
export default function PropertyDetailsV1({ searchParams }) {
								...
								<div className="header-property-detail">
									<div className="content-top d-flex justify-content-between align-items-center">
										<div className="box-name">
											...
											<h4 className="title link">{product.title}</h4>
										</div>
									...
									<div className="content-bottom">
										...
										<div className="info-box">
											...
											<p className="meta-item"><span className="icon icon-mapPin" />{product?.location?.placeName}, {product?.location?.address}</p>
										</div>
											...
											<div className="row">
												<div className="col-md-6">
													<div className="inner-box">
														...
														<div className="content fw-7">{product._id}</div>
													</div>
												</div>
												<div className="col-md-6">
													<div className="inner-box">
												...
												<div className="col-md-6">
													<div className="inner-box">
														...
														<div className="content fw-7">{product.offerPrice}<span className="caption-1 fw-4 text-variant-1">/month</span></div>
													</div>
												</div>
												<div className="col-md-6">
													<div className="inner-box">
												...
												<div className="col-md-6">
													<div className="inner-box">
														...
														<div className="content fw-7">{product.name}</div>
													</div>
												</div>
												<div className="col-md-6">
													<div className="inner-box">
